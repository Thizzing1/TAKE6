    ...
    <div className="mobile-big-connect">
      <div className="container">
        ...
        <div className="overlay-shadow">
          ...
          <div className="container-12">
            <img className="img-2" alt="X button" src="/img/x-button-375.svg" />
            ...
            <img
              className="img-2"
              alt="Button"
              src="/img/unknown2-button-425-1.svg"
            />
          </div>
        </div>
